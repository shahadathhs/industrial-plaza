  ...
  return (
    <HelmetProvider>
      <div>
        ...
        <div className="sm:px-3 md:px-3 lg:px-12 sm:py-2 md:py-3 lg:py-6 space-y-4 my-4 bg-base-200">
          <h2 className="text-center text-gray-500 text-2xl font-bold">
            TESTIMONIALS
          </h2>
          <p className="text-center text-gray-500 text-lg px-8">
          ...
          <div className="mx-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 justify-center">
              <div className="space-y-3 bg-white border-2 border-orange-500 p-2 rounded-xl">
