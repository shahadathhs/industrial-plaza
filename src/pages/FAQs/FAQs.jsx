  ...
  return (
    <HelmetProvider>
      <div>
        ...
        <div className="sm:px-1 md:px-3 lg:px-12 sm:py-2 md:py-3 lg:py-6 space-y-4 my-4">
          <h2 className="text-center text-3xl font-bold text-blue-500">FAQ (Frequently Asked Questions)</h2>
          <p className="text-center text-lg p-8 pt-0">Welcome to our FAQ page! Get quick answers to common questions about industrial real estate. Browse categories, search for specific topics, and empower your decision-making with expert insights and practical guidance.</p>
          {/* Q&A */}
